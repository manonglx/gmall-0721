...
import com.atguigu.gmall.psm.service.AttrAttrgroupRelationService;
...
@RestController
@RequestMapping("psm/attrattrgrouprelation")
public class AttrAttrgroupRelationController {
    ...
    @GetMapping("/list")
    @PreAuthorize("hasAuthority('psm:attrattrgrouprelation:list')")
    ...
    @ApiOperation("详情查询")
    @GetMapping("/info/{id}")
    @PreAuthorize("hasAuthority('psm:attrattrgrouprelation:info')")
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @PreAuthorize("hasAuthority('psm:attrattrgrouprelation:save')")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @PreAuthorize("hasAuthority('psm:attrattrgrouprelation:update')")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @PreAuthorize("hasAuthority('psm:attrattrgrouprelation:delete')")
